...
- 0–3열 걷기, 4–7열 공격
- 알파 `16` 초과 픽셀 기준 발바닥 최하단 `y=248`(셀 하단 7px)
- 프레임 콘텐츠 최대 `232×232px`
...
|---|---:|---:|---:|---:|---:|---|
| `ulleung-magistrate-actions-v1.png` | 1종 | 40/40 | 227×205 | 4/4 | 4/4 | 통과 |
| `joseon-crown-prince-actions-v1.png` | 1종 | 40/40 | 170×166 | 4/4 | 4/4 | 통과 |
| `joseon-peasant-militia-actions-v1.png` | 1종 | 40/40 | 138×198 | 4/4 | 4/4 | 통과 |
...
| `episode2-red-fox-actions-v1.png` | 1종 | 40/40 | 199×172 | 4/4 | 4/4 | 통과 |
| `episode2-stone-dokkaebi-actions-v1.png` | 1종 | 40/40 | 199×199 | 4/4 | 4/4 | 통과 |
...
| `jurchen-commander-actions-v1.png` | 1종 | 40/40 | 141×158 | 4/4 | 4/4 | 통과 |
| `jurchen-lancer-actions-v1.png` | 1종 | 40/40 | 169×199 | 4/4 | 4/4 | 통과 |
