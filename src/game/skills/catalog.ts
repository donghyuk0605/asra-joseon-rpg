...
export const SKILL_CATALOG: Record<SkillId, SkillDefinition> = {
  ...
  'tidebreaker-step': {
    ...
    acquisitionLabel: '서해 조운로 수련',
    description: '밀려드는 파도를 가르듯 전방으로 낮게 파고든 뒤 되밀리는 충격을 원형으로 터뜨립니다.',
    effect: '장거리 돌진 · 착지 광역 · 강한 밀침',
    maxRank: 3,
    iconClass: 'skill-tidebreaker-step',
    requiredWeapon: 'melee',
  },
  'haemosu-volley': {
    id: 'haemosu-volley',
  ...
  'beacon-volley': {
    ...
    kind: 'active',
    acquisition: 'training',
    acquisitionLabel: '관동 봉수대 수련',
    description: '봉수의 점화 순서를 따라 가까운 적에서 먼 적으로 불화살을 연달아 이어 쏩니다.',
    effect: '거리순 연쇄 사격 · 최대 4~7명 · 화염 경직',
    maxRank: 3,
    iconClass: 'skill-beacon-volley',
    requiredWeapon: 'bow',
  },
  'spirit-bell': {
    id: 'spirit-bell',
